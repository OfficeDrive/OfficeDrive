...
typelib_path = os.path.normpath(
    os.path.abspath(os.path.join(os.path.dirname(__file__),
                                 'C:\\Python27\\Lib\\site-packages\\comtypes\\gen\\TaskbarLib.tlb')))
...
__all__ = ['TBATFLAG', 'TBPF_ERROR', '__MIDL_IWinTypes_0009',
           'TaskbarList', 'TBPF_INDETERMINATE', 'TBPFLAG',
           'ITaskbarList', 'TBPF_NORMAL', 'TBPF_NOPROGRESS',
           'TBPF_PAUSED',
           '__MIDL___MIDL_itf_TaskbarLib_0006_0001_0001',
           'TBATF_USEMDILIVEPREVIEW', 'TBATF_USEMDITHUMBNAIL',
           'tagTHUMBBUTTON', 'ITaskbarList2', 'ITaskbarList3',
           '_RemotableHandle']
